    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center">
                <a href="{{ route('events.create') }}" class="bg-gray-800 hover:bg-gray-700 text-white font-semibold py-1 px-3 rounded-lg mr-2 flex items-center">
                    ...
                    <span class="ml-2">Neuer Event</span>
                </a>
            </div>
        </div>
    </x-slot>
