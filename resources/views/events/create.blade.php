    ...
    <div class="mt-10 max-w-3xl mx-auto">
        ...
        <form method="post" action="{{ route('events.store') }}">
            ...
            <div class="flex items-center mb-10">
                ...
                <input type="text" id="title" name="title" class="flex-grow rounded-lg py-1 px-3"
                       value="{{ old('title') }}" required>
            </div>
            <div class="flex items-center mb-10">
                <label for="date" class="text-2xl flex-1">Datum</label>
                <input style="width: 15rem;" type="date" id="date" name="date" class="flex-grow rounded-lg py-1 px-3"
                       value="{{ old('date') }}" required>
            </div>
            <div class="flex items-baseline mb-10">
                <label for="description" class="text-xl flex-1">Beschreibung</label>
                <textarea id="description" name="description" cols="18" rows="6" class="flex-grow rounded-lg py-1 px-3"
                          required>{{ old('description') }}</textarea>
            </div>
            <div class="flex items-center mb-10">
                <label for="max_adults" class="text-xl flex-1">Max. Erwachsene</label>
                <input type="number" min="0" id="max_adults" name="max_adults" class="flex-grow rounded-lg py-1 px-3"
            ...
            <div class="flex items-center mb-10">
                ...
                <input type="number" min="0" id="max_children_old" name="max_children_old"
                       ...
                       class="flex-grow rounded-lg py-1 px-3" required>
            </div>
            <div class="flex items-center mb-10">
            ...
            <div class="flex items-center mb-10">
                ...
                <input type="number" min="0" id="max_babies" name="max_babies" class="flex-grow rounded-lg py-1 px-3"
