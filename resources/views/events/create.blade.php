    ...
    <div class="mt-10 max-w-3xl mx-auto">
        ...
        <form method="post" action="{{ route('events.store') }}">
            ...
            <div class="flex items-center mb-10">
                ...
                <input type="number" min="0" id="max_lions" name="max_lions" class="flex-grow rounded-xl py-1 px-3" required>
            </div>
            <div class="flex items-center mb-10">
                <label for="max_kangaroos" class="text-2xl flex-1">Max. Kängurus (Kindertreff)</label>
                <input type="number" min="0" id="max_kangaroos" name="max_kangaroos" class="flex-grow rounded-xl py-1 px-3" required>
            </div>
            <div class="flex items-center mb-10">
